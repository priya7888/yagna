...
import { Loader2, Mail, Lock, User, Trophy, Zap } from 'lucide-react';
    ...
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Start your gamified financial literacy journey
          </DialogDescription>
        </DialogHeader>
          ...
          <TabsContent value="signup" className="space-y-4">
            <Card>
              <CardHeader className="pb-4">
                ...
                <CardDescription>Join thousands of learners improving their financial literacy</CardDescription>
              </CardHeader>
              <CardContent>
